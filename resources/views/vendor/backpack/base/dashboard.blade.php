...
@section('header')
    <section class="content-header">
      <h1 class="bg-primary" style="padding: 30px;">
        {{ trans('backpack::base.dashboard') }},   <i>Welcome </i> <a href="{{ route('backpack.account.info') }}"> <span class="fa fa-user" style="font-weight: bolder; color: #ffffff;"> {{ Auth::user()->name }}</span></a>
      </h1>
      <ol class="breadcrumb">
        ...
        <div class="col-md-12">
            <div class="box box-default">
                <div class="box-header with-border">
                    <div class="box-title">{{ trans('backpack::base.login_status') }}, <span class="fa fa-calendar"></span> {{ \Carbon\Carbon::now()->toDayDateTimeString() }}</div>
                </div>
    ...
    {{--<div class="row">--}}
        {{--<div class="col-md-6">--}}
            ...
            {{--<div class="box box-info">--}}
                {{--<div class="box-header with-border">--}}
                    {{--<h3 class="box-title">Latest Suggestions</h3>--}}
